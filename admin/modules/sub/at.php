...
<div class="container-fluid">
    <div class="row">
	                    <div class="col-md-12">
							<h4 class="title">Approved Tasks List</h4>
							...
							<br>
									            ...
									            <?php
									             ...
									             include "task_handler.php";
                                                   ...
                                                   $sql_prepare = 'SELECT task_id,tagr_id,task_code,attributes,total_tags,minutes,avg,a_w_m,t_w_m,usd,cr_d FROM tasks WHERE task_status=1 ';
                                                                                                 $stmt = $con->prepare($sql_prepare); 
                                                                                                 $stmt->execute();
                                                                                                 $stmt->bind_result($task_id,$tagr_id,$task_code,$attributes,$total_tags,$minutes,$avg,$a_w_m,$t_w_m,$usd,$cr_d);
                                                                                                 $stmt->store_result();
                                                                                                 $json_data = array();
	                            ...
	                            <div class="card-content">
                                    ...
                                    <div class="fresh-datatables">
										...
										<tbody>
										 ...
										 while($stmt->fetch())
										 {
										     $json_data = array('task_id'=>$task_id,'tagr_id'=>$tagr_id,'task_code'=>$task_code,'attributes'=>$attributes,'total_tags'=>$total_tags,'minutes'=>$minutes,'avg'=>$avg,'a_w_m'=>$a_w_m,'t_w_m'=>$t_w_m,'usd'=>$usd,'cr_d'=>$cr_d);
											 ...
											 <td><?php
                                                ...
                                                ?></td>
												 ...
												 <td><?php  
													...
													if($json_data['a_w_m'] == 0 ||  $json_data['a_w_m'] == '')
													{
													    echo '----';
													}else{
													   	echo '-'.$json_data['a_w_m']; 
													}
													...
													if($json_data['t_w_m'] == 0 ||  $json_data['t_w_m'] == '')
													{
													    echo '----';
													}else{
													   	echo '-'.$json_data['t_w_m']; 
													}
												...
												<td>
											      ...
											      <a href="dashboard?page=task&sub=<?php echo $_GET['sub'];?>&id=<?php echo urlencode(base64_encode($json_data['task_id']));?>&t_id=<?php echo urlencode(base64_encode($json_data['tagr_id']));?>" onclick="return confirm('Are you sure you want to remove this Task?')" class="btn btn-simple btn-danger btn-icon"><i class="ti-close"></i></a>
