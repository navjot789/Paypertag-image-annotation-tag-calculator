            ...
            elseif($response->success == false)
                 ...
                 else 
                 {
                      ...
                      $token =  md5(uniqid(rand(), TRUE));
                       ...
                       $global_tagger = 2;
                       $stmt = $con->prepare('INSERT INTO taggers(tagr_type,token,username,email,password,cr_d) VALUES(?, ?, ?, ?, ?, ?)');
                       $stmt->bind_param('isssss',$global_tagger,$token,$username,$email,$encrypt_passwords,$current_date);
                                                                        ...
                                                                        $mail->msgHTML($content);
                                                                             ...
                                                                             if($mail->send()) 
                                                                             {
                                                                                 ...
                                                                                 $success='    <div class="alert alert-success">  
                                                                                                        <button type="button" class="close" data-dismiss="alert">×</button>  
                                                                                                        <strong>Success.</strong> Thank you For registering with us, Wait for 2-3 Minutes and check your 
                                                                                                                             email Address to activate your account. Dont forget to check spam folder. 
                                                                                                    </div>  ';	
        ...
        <div class="header-body text-center  mb-4">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white"> I bet its Much better than a Notebook!</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center">
        ...
        ?>
          ...
          <div class="row mt-3">
            ...
            <div class="col-6">
              <a href="password_reset" class="text-light"><small>Already have an Account?</small></a>
            </div>
          <div class="col-6 text-right">
              <a href="https://paypertag.tk/password_reset" class="text-light"><small>Resend Link?</small></a>
            </div>
