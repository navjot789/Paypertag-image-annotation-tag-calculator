   ...
   <!-- Card stats -->
          <div class="row">
              ...
              <div class=" col-md-12" style="overflow:auto;max-height:800px;">
                ...
                <div class="card-body">
                  <h3 class="card-title text-white">Microwork.io Current Batch Information</h3>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">
                           <?php
                            //total tasks
                                                                     $sql_prepare = 'select task_id from tasks where tagr_id = ?';
                          ...
                          <?php
                                 //current week tasks
                                                                     $sql_prepare = 'SELECT task_id FROM tasks WHERE c_date between "'.$dFrom_current.'" AND "'.$dTo_current.'" AND tagr_id = ?';
                                                                     $stmt = $con->prepare($sql_prepare); 
                                                                     $stmt->bind_param('i',$_SESSION['tagr_id']);
                                                                     $stmt->execute();
                  ...
                  <p class="mt-3 mb-0 text-sm">
                    ...
                    //last week tasks
                                                                     ...
                                                                     $sql_prepare = 'SELECT task_id FROM tasks WHERE c_date between "'.$dFrom.'" AND "'.$dTo.'" AND tagr_id = ?';
                                                                     $stmt = $con->prepare($sql_prepare); 
                                                                     $stmt->bind_param('i',$_SESSION['tagr_id']);
                                                                     $stmt->execute();
                                                                     $stmt->bind_result($task_id);
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">
                                ...
                                <?php
                                //total tags
                                                                     $sql_prepare = 'select sum(total_tags) from tasks where tagr_id = ?';
                                                                     $stmt = $con->prepare($sql_prepare); 
                                                                     $stmt->bind_param('i',$_SESSION['tagr_id']);
                                                                     $stmt->execute();
                      ...
                      <h5 class="card-title text-uppercase text-muted mb-0">this week</h5>
                       <?php
                       //current week tags
                                                                     $sql_prepare = 'SELECT sum(total_tags) FROM tasks WHERE c_date between "'.$dFrom_current.'" AND "'.$dTo_current.'" AND tagr_id = ?';
                                                                     $stmt = $con->prepare($sql_prepare); 
                                                                     $stmt->bind_param('i',$_SESSION['tagr_id']);
                                                                     $stmt->execute();
                                                                     $stmt->bind_result($total_tags);
                  ...
                  <p class="mt-3 mb-0 text-sm">
                    <span class="text-success mr-2"> <i class="fas fa-tags"></i> 
                      ...
                      <?php
                      //last week tags
                                                                     $sql_prepare = 'SELECT sum(total_tags) FROM tasks WHERE c_date between "'.$dFrom.'" AND "'.$dTo.'" AND tagr_id = ?';
                                                                     $stmt = $con->prepare($sql_prepare); 
                                                                     $stmt->bind_param('i',$_SESSION['tagr_id']);
                                                                     $stmt->execute();
                                                                     $stmt->bind_result($total_tags);
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <?php
                    //total  mistakes
                                                                     $sql_prepare = 'SELECT (sum(a_w_m) + sum(t_w_m)) FROM tasks WHERE tagr_id = ?';
                                                                     $stmt = $con->prepare($sql_prepare); 
                                                                     $stmt->bind_param('i',$_SESSION['tagr_id']);
                                                                     $stmt->execute();
                  ...
                  ?>
                      ...
                      <?php
                          //current week mistakes
                                                                  $sql_prepare = 'SELECT (sum(a_w_m) + sum(t_w_m)) FROM tasks WHERE c_date between "'.$dFrom_current.'" AND "'.$dTo_current.'" AND tagr_id = ?';
                                                                     $stmt = $con->prepare($sql_prepare); 
                                                                     $stmt->bind_param('i',$_SESSION['tagr_id']);
                                                                     $stmt->execute();
                                                                     $stmt->bind_result($total_mistakes);
                  ...
                  <p class="mt-3 mb-0 text-sm">
                    <span class="text-success mr-2"><i class="fas fa-minus-circle"></i>
                        ...
                        <?php
                            //last week mistakes
                                                                  $sql_prepare = 'SELECT (sum(a_w_m) + sum(t_w_m)) FROM tasks WHERE c_date between "'.$dFrom.'" AND "'.$dTo.'" AND tagr_id = ?';
                                                                     $stmt = $con->prepare($sql_prepare); 
                                                                     $stmt->bind_param('i',$_SESSION['tagr_id']);
                                                                     $stmt->execute();
                                                                     $stmt->bind_result($total_mistakes);
                ...
                <div class="card-body">
                       ...
                       <?php
                                                      ...
                                                      function convertCurrency($amount,$from_currency,$to_currency){
                                                          ...
                                                          return number_format($total, 2, '.', '');
                                                                     ...
                                                                     $approved = 1;
                                                                     $sql_prepare = 'SELECT sum(usd) FROM tasks WHERE task_status =? AND tagr_id = ?';
                                                                     $stmt = $con->prepare($sql_prepare); 
                  ...
                  ?>
                    <h5 class="card-title text-uppercase text-muted mb-0">this week</h5>  
                      <?php                                         //calculating current week earings
                                                                   $sql_prepare = 'SELECT sum(usd) FROM tasks WHERE c_date between "'.$dFrom_current.'" AND "'.$dTo_current.'" AND task_status =? AND tagr_id = ?';
                                                                     $stmt = $con->prepare($sql_prepare); 
                                                                     $stmt->bind_param('ii',$approved,$_SESSION['tagr_id']);
                                                                     $stmt->execute();
                  ...
                  <p class="mt-3 mb-0 text-sm">
                    ...
                    <?php                                             //calculating last week earings
                                                                     $sql_prepare = 'SELECT sum(usd) FROM tasks WHERE c_date between "'.$dFrom.'" AND "'.$dTo.'" AND task_status =? AND tagr_id = ?';
                                                                     $stmt = $con->prepare($sql_prepare); 
                                                                     $stmt->bind_param('ii',$approved,$_SESSION['tagr_id']);
                                                                     $stmt->execute();
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">
                          ...
                          <?php
                                                                     $pending = 0;
                                                                     $sql_prepare = 'select task_id from tasks where task_status= ? AND tagr_id = ?';
                                                                     $stmt = $con->prepare($sql_prepare); 
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">REJECTED TASKS</h5>
                      <span class="h2 font-weight-bold mb-0">
                             <?php
                                                                     $reject = 2;
                                                                     $sql_prepare = 'select task_id from tasks where task_status= ? AND tagr_id = ?';
                                                                     $stmt = $con->prepare($sql_prepare); 
                                                                     $stmt->bind_param('ii',$reject,$_SESSION['tagr_id']);
                                                                     $stmt->execute();
                                                                     $stmt->store_result();
                                                                     if( $stmt->num_rows >0)
                                                                     {
                  ...
                  <p class="mt-3 mb-0 text-sm">
                    <span class="text-red mr-2"><i class="fas fa-exclamation-circle"></i></span>
                    <span class="text-nowrap" style="font-size:13px;">Rejected Tasks</span>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0"> Minimum Limit</h5>
                      <span class="h4 font-weight-bold mb-0">
                             <?php
                                                                     $reject = 2;
                                                                     $sql_prepare = 'select task_id from tasks where task_status= ? AND tagr_id = ?';
                                                                     ...
                                                                     {
                                                                         echo '<span class="text-nowrap" style="color:red;font-size:12px;">Limit Not Set.</span>';
                                                                     }
                  ...
                  <p class="mt-3 mb-0 text-sm">
                    <span class="text-info mr-2"><i class="fas fa-info-circle"></i></span>
                    <span class="text-nowrap" style="font-size:13px;">Your Weekly Minimum limit</span>
                  </p>
                </div>
              </div>
            </div>
         ...
         <div class="col-md-12">
              <div class="card mb-4">
                                ...
                                <div class="card-header">
                                  <h3 class="mb-0"><i class="fas fa-globe-asia"></i> See how others doing their Tasks!</h3>
                                 
                                </div>
                                
                                <?php
                               
                                    $sql_prepare_query = 'SELECT tagr_id,total_tags,minutes,avg,usd,cr_d FROM tasks order by task_id desc';
                                      ...
                                      ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php   echo $user_obj['username'];        ?></td>
                                                ...
                                                <td><?php echo  get_time_ago(strtotime($json['cr_d'])); ?></td>
