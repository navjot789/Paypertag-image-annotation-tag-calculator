  ...
  <div class="container-fluid mt--6">
       <div class="card">
                    <div class="card-header">
                      <h3 class="mb-0"><a href="dashboard?page=preview_task"><i class="fas fa-arrow-circle-left"></i> Go Back</a></h3>
                    </div>
        ...
        <div class="card">
                    ...
                    <div class="card-header">
                      <div class="row align-items-center">
                        <div class="col-8">
                          <!-- Title -->
                        <h3 class="mb-0"><a href="dashpanel?page=preview_task"><i class="fas fa-arrow-circle-left"></i> Go Back</a></h3>
                        </div>
