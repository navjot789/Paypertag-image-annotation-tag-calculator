 ...
 if(isset($_POST['add']))
       {
              ...
              //now lets check if user task_code in already exist
                    $stmts = $con->prepare('SELECT task_id FROM tasks WHERE task_code = ?');
                    $stmts->bind_param('s', $code);
                      ...
                      if(empty($batch) || empty($code) || empty($tasks) || empty($time))
                       {
                                                                          ...
                                                                          if( strpos($time,'.') !== false || ctype_digit($time) || $time =='')
                                                                                             {
                                                                                                          ...
                                                                                                          if(empty($batch))
                                                                                                           ...
                                                                                                           $sql_prepare = 'insert into tasks(b_id,tagr_id,task_code,attributes,total_tags,minutes,avg,usd,cr_d,c_date) 
                                                                                                           values("'.$batch.'",
                                                                                                                  "'.$_SESSION['tagr_id'].'",
                                                                                                                  "'.$code.'",
                                                                                                                  "'.$atributes.'",
            ...
            <div class="col">
              ...
              <div class="card mb-4">
                                ...
                                <div class="card-header">
                                  <h3 class="mb-0"><i class="fas fa-plus"></i> Add New Task (SOLO)</h3>
                                             ...
                                             <div class="row">
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                      ...
                                                      <div class="col-md-3">
                                                      <div class="form-group">
                                                        <label class="form-control-label" for="example3cols2Input"><i class="fas fa-hourglass-end"></i> Minutes <code>*</code></label>
            ...
            <div class="col">
              <div class="card mb-4" >
                                ...
                                <?php
                                    ...
                                    $sql_prepare_query = 'SELECT task_code,attributes,total_tags,minutes,usd,cr_d FROM tasks WHERE tagr_id= ? order by task_id desc';
                       ...
                       <div class="card">
                               ...
                               <div class="accordion" id="accordionExample">
                                       ...
                                       <div class="card">
                                            ...
                                            <div class="card-header">
                                              ...
                                              <h4 class=" mb-0">
                                                  <span class="badge badge-dot mr-4">
                                                                        ...
                                                                        <span class="status"> LIVE <strong>USD</strong> into <strong>INR</strong> Conversion</span>
                                                                      </span>
                                                 </h4>
                                            </div>
                                            ...
                                            $sql_prepare = 'SELECT usd,cr_d FROM tasks WHERE tagr_id= ? order by task_id DESC LIMIT 1';
                                            $stmts = $con->prepare($sql_prepare); 
                                            $stmts->bind_param("i", $_SESSION['tagr_id']);
                                            $stmts->execute();
                                            $stmts->bind_result($dollar,$date);
                                            ...
                                            <div class="card-body p-0">
                                              ...
                                              <?php
                                                 $object = array();
                                                   ...
                                                   $object = array('dollar'=>$dollar,'date'=>$date);
                                                    ...
                                                    function convertCurrency($amount,$from_currency,$to_currency){
                                                         ...
                                                         $current = convertCurrency(1, 'USD', 'INR'); //function calling
                                                         $navtive_currency = convertCurrency($object['dollar'], 'USD', 'INR'); //function calling
                                              ...
                                              ?>
                                                ...
                                                <li class="list-group-item ">
                                                      <div class="row "><div class="col-auto">   <h2 class="checklist-title mb-0">Current Live Rate:</h2> </div></div>
                                                                  <div class="row align-items-center">
                                                                    <div class="col-auto">
                                                                      <!-- Country flag -->
                                                                    <img src="https://www.countryflags.io/us/flat/32.png" style="margin-left:10px;">
                                                                    </div>
                                                                    <div class="col">
                                                                      <small>Country:</small>
                                                                    ...
                                                                    <div class="col">
                                                                      <small>USD:</small>
                                                                      <h5 class="mb-0" style="color:#43e972;">$1.00</h5>
                                                                    </div>
                                                                    <div class="col">
                                                                      <small>INR:</small>
                                                                      <h5 class="mb-0" style="color:#43e972;"><?php echo $current; ?></h5>
                                                                    </div>
                                                                  </div>
                                                              ...
                                                              <li class="list-group-item ">
                                                                    <div class="row "><div class="col-auto">Recently Added Task:</div></div>
                                                                  <div class="row align-items-center">
                                                                    <div class="col-auto">
                                                                      <!-- Country flag -->
                                                                    <img src="https://www.countryflags.io/in/flat/32.png" style="margin-left:10px;">
                                                                    </div>
                                                                    <div class="col">
                                                                      <small>Country:</small>
                                                                    ...
                                                                    <div class="col">
                                                                      <small>USD:</small>
                                                                      <h5 class="mb-0" style="color:#43e972;">$<?php echo $object['dollar'];?></h5>
                                                                    </div>
                                                                    <div class="col">
                                                                      <small>INR:</small>
                                                                      <h5 class="mb-0" style="color:#43e972;"><?php echo $navtive_currency; ?></h5>
                                                                    </div>
                                                                  </div>
                                                ...
                                                <li class=" list-group-item flex-column align-items-start px-4">
                                                
                                                  
                                                     <h6 class="float-right">Posted at : <?php echo  get_time_ago(strtotime($object['date']));  ?></h6>
