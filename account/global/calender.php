          ...
          <div class="card card-calendar">
            ...
            <div class="card-header">
              ...
              <h5 class="h3 mb-0"><i class="fas fa-calendar-alt"></i> Calendar</h5>
               ...
               <a href="<?php echo $_SERVER['PHP_SELF'].'?p=calender&week='.($week-1).'&year='.$year; ?>"> <i class="fas fa-arrow-alt-circle-left"></i> Pre Week</a> <!--Previous week-->
               <a class="float-right" href="<?php echo $_SERVER['PHP_SELF'].'?p=calender&week='.($week+1).'&year='.$year; ?>">Next Week <i class="fas fa-arrow-circle-right"></i></a> <!--Next week-->
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <td class="fc-day fc-widget-content fc-sun fc-past" >
                                                                                            ...
                                                                                            foreach($this_week as $key=>$value)
                                                                                               ...
                                                                                               $sql_prepare_query_0 = 'SELECT task_code,total_tags FROM global_tasks WHERE tagr_id = ? AND c_date = ?';
                                                                                   ...
                                                                                   $sql_prepare_query_1 = 'SELECT total_tags FROM global_tasks WHERE tagr_id = ? AND c_date = ?';
                                                                                   ...
                                                                                   $sql_prepare_query_2 = 'SELECT total_tags FROM global_tasks WHERE tagr_id = ? AND c_date = ?';
                                                                                   ...
                                                                                   $sql_prepare_query_3 = 'SELECT total_tags FROM global_tasks WHERE tagr_id = ? AND c_date = ?';
                                                                                ...
                                                                                <td class="fc-day fc-widget-content fc-sun fc-past" >
                                                                                   ...
                                                                                   $sql_prepare_query_4 = 'SELECT total_tags FROM global_tasks WHERE tagr_id = ? AND c_date = ?';
                                                                                  ...
                                                                                  <td class="fc-day fc-widget-content fc-sun fc-past" >
                                                                                   ...
                                                                                   $sql_prepare_query_5 = 'SELECT total_tags FROM global_tasks WHERE tagr_id = ? AND c_date = ?';
                                                                                   ...
                                                                                   $sql_prepare_query_6 = 'SELECT total_tags FROM global_tasks WHERE tagr_id = ? AND c_date = ?';
