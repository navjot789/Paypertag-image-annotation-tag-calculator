          ...
          <div class="card card-calendar">
            ...
            <div class="card-header">
              ...
              <h5 class="h3 mb-0"><i class="ni ni-money-coins text-success"></i> Weekly Payments</h5>
               ...
               <a href="<?php echo $_SERVER['PHP_SELF'].'?p=payments&week='.($week-1).'&year='.$year; ?>"> <i class="fas fa-arrow-alt-circle-left"></i> Pre Week</a> <!--Previous week-->
               
              
                
                
                
               <a class="float-right" href="<?php echo $_SERVER['PHP_SELF'].'?p=payments&week='.($week+1).'&year='.$year; ?>">Next Week <i class="fas fa-arrow-circle-right"></i></a> <!--Next week-->
          ...
          <div class="card">
            ...
            <?php
                                                             ...
                                                             foreach($this_week as $key=>$value)
                                                               ...
                                                               echo '<strong>('.$week_end.')</strong>';
                                                               
                                                               
                                                               
                                                               
                                                 //current week sql queries
									           $sql_prepare = 'SELECT taggers.tagr_id, sum(global_tasks.attributes),sum(global_tasks.total_tags),sum(global_tasks.a_w_m),sum(global_tasks.t_w_m),sum(global_tasks.usd), taggers.username FROM taggers INNER JOIN global_tasks ON taggers.tagr_id=global_tasks.tagr_id WHERE global_tasks.c_date BETWEEN "'.$this_week[$key_0].'" AND "'.$this_week[$key_6].'" AND global_tasks.tagr_id="'.$_SESSION['tagr_id'].'" AND taggers.tagr_type=2 AND taggers.status=1'; //join table tagger and task for getting tags of perticular week.
                                               ...
                                               //getting total tasks  done by perticular taggger      
                                                $stmts = $con->prepare('SELECT task_id FROM global_tasks WHERE c_date BETWEEN "'.$this_week[$key_0].'" AND "'.$this_week[$key_6].'" AND tagr_id="'.$_SESSION['tagr_id'].'"');                   
                       ...
                       if(date('Y-m-d') >= $this_week[$key_0] && date('Y-m-d') <= $this_week[$key_6])  //disabling current week payment invoice
                       {
                            echo   '<tr>
                                        ...
                                        <div class="alert alert-info  fade show text-center" role="alert">
                                             ...
                                             <span class="alert-text"><strong>Invoice Not Generated!</strong> Current week invoice is not generated yet, check back on monday.</span>
                                                ...
                                                <td class="right"><?php  
                                                  ...
                                                  <td class="right"><?php   if($json_data['totle_usd_of_tagr']==0 || $json_data['totle_usd_of_tagr']=='')
                                                                   ...
                                                                   }else
                                                                   {
                                                                        ...
                                                                        echo '<strong>'.'<span  style="color:#6ddd8c;">$'.number_format((float)$json_data['totle_usd_of_tagr'], 2, '.', '').'</span>'.'<strong>';
                                                                   }
                        ...
                        <tr>
                            <td colspan="7">
                                <div class="alert alert-warning  fade show text-center" role="alert">
                                     ...
                                     <span class="alert-text"><strong>No Invoice Found!</strong> There is No Work done for this week.</span>
