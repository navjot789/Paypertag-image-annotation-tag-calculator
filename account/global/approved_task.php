            ...
            <div class="col">
              <div class="card mb-4" >
                                ...
                                <div class="card-header">
                                  <h3 class="mb-0"><i class="fas fa-clock"></i> Approved Task List</h3>
                                 
                                </div>
                                
                                <?php
                                
                                    $sql_prepare_query = 'SELECT task_code,attributes,total_tags,minutes,avg,usd,cr_d FROM global_tasks WHERE tagr_id= ? AND task_status=1 order by task_id desc';
                                ...
                                <!-- Card body -->
                                  ...
                                  <div class="table-responsive py-2" >
                                      ...
                                      ?>
                                        ...
                                        <tr  style="background-color:#b7f8b2;">
                                            ...
                                            <td><?php echo $i; ?></td>
                                               ...
                                               <td class="text-right">
                                                   ...
                                                   <!--  <a href="dashpanel?p=task_updating&t=<?php echo urlencode(base64_encode($json['task_code']));?>" onclick="return confirm('Are you sure you want to delete Edit this Task?')" class="dropdown-item" name="delete_task"> <i class="fas fa-edit text-success"></i> Edit</a>
                                                     -->
                                                      <a href="global/handler.php?a_val=<?php echo urlencode(base64_encode($json['task_code']));?>" onclick="return confirm('Are you sure you want to delete this Task? Beware this Action Cannot be Revoke!')" class="dropdown-item" name="delete_task"> <i class="fas fa-trash-alt text-red"></i> Remove</a>
